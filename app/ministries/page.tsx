    ...
    <>
      <div className="container">
        ...
        <div className="row">
          ...
          <div className="grid-3">
            <Image src={schoolImg} alt="Image Ignite Evangelism" width={260} height={190} className="img-ministries" />
          ...
          <div className="grid-3">
            <Image src={musicImg} alt="Image Ignite Evangelism" width={260} height={190} className="img-ministries" />
        ...
        <div className="row">
          <div className="grid-3">
            <Image src={podcastImg} alt="Image Ignite Evangelism" width={260} height={190} className="img-ministries" />
